...
class UrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create url" do
    assert_difference('Url.count') do
      post urls_url, params: { url: { original_url: @url.original_url, short_url: @url.short_url } }
    end
  ...
  test "should update url" do
    patch url_url(@url), params: { url: { original_url: @url.original_url, short_url: @url.short_url } }
